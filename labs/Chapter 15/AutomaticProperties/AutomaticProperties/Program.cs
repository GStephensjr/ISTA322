    ...
    class Program
    {
        static void doWork()
        {
            ...
            Console.WriteLine($"Square: number of sides is " +
                $"{square.NumSides}, length of each sideis { square.SideLength }");
            Console.WriteLine($"Triangle: number of sides is " +
                $"{triangle.NumSides}, length of each side is { triangle.SideLength }");
            Console.WriteLine($"Pentagon: number of sides is " +
                $"{pentagon.NumSides}, length of each side is { pentagon.SideLength }");
        }
